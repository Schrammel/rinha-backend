...
import { DESCRICAO_INVALIDA, SALDO_INSUFICIENTE, TIPO_DE_TRANSACAO_INVALIDA, VALOR_INTERIO, VALOR_NEGATIVO, cadastraClientes, extrato, prisma, submeterTransacao, validacaoSintetica } from "./createTransaction";
